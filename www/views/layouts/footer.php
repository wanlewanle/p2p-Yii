...
<div id="footer">
    <div class="foot_top main">
        <div class="dilb left">
            <ul>
                <h5>我要投资</h5>
                <li><a href="<?php echo yii\helpers\Url::to(['investment/investing']); ?>">活琪王</a></li>
            </ul>
            <!--            <ul>-->
            <!--            	<h5>安全保障</h5>-->
    ...
    <div class="foot_bot">
        <div class="main">
            <p>ICP备案编号：京ICP备15037172号-1 版权所有 北京活琪王投资有限公司</p>

<!--            <p><a href="//webscan.360.cn/index/checkwebsite/url/www.huoqiwang.com"><img border="0"-->
...
<!--            </p>-->
            <table style="margin-left:45%;" width="135" border="0" cellpadding="2" cellspacing="0" title="Click to Verify - This site chose GeoTrust SSL for secure e-commerce and confidential communications.">
                <tr>
                    <td width="135" align="center" valign="top"><script type="text/javascript" src="https://seal.geotrust.com/getgeotrustsslseal?host_name=www.huoqiwang.com&amp;size=S&amp;lang=en"></script><br />
