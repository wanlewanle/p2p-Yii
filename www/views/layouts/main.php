...
/* @var $content string */
    ...
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title><?= Html::encode($this->title).' - 活琪王 - 活期理财，我们更专业' ?></title>
        <?php $this->registerMetaTag(['name'=>'keywords','content'=>$keywords]);?>
		<?php $this->registerMetaTag(['name'=>'description','content'=>'活琪王是一家专注于活期理财的互联网金融公司，为广大用户提供安全、便捷、灵活的活期理财项目，是互联网+时代高效实用稳健的互联网金融服务平台。']);?>
        <?php $this->head() ?>
