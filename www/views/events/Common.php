...
<div style="height:60px;font-size:0;background-color:#000" id="jq-appendDIV">
    <div id="jq-download"
        ...
        <div style="width:60px;text-align:center;position:absolute;">
            <img style="width:40px;height:40px" src="//static.huoqiwang.com/imgs/logo7878.png">
        </div>
        <div style="position:absolute;left:60px">
            <div style="font-size:22px;color: #006fbb;font-weight:bold;line-height:22px">活琪王理财</div>
        ...
        <div id="closeDiv" style="position:absolute;top:5px;right:5px;width:20px;height:20px"><img
                ...
                src="//static.huoqiwang.com/imgs/modifydelete.png">
        </div>
    </div>
</div>
<div class="hqw_main">
    ...
    <section class="regular">
        <div class="rule_wp">
            <h5>活动规则</h5>
            <ol class="rule">
                <li>领取流程：通过输入手机号验证即可领取活琪王6666元体验金。</li>
...
<script>
    ...
    $('#jq-content').click(function(){
            window.location.href="http://a.app.qq.com/o/simple.jsp?pkgname=com.huoqiwang";
    });
