            ...
            <div class="main">
                ...
                <div class="zc_bd" id= 'red_packet' style="display:none;">
                   ...
                   <div align="center" style="margin-top:10px;">
                        <img src="http://static.huoqiwang.com/imgs/download.png" style="height: 157px;width: 158px">
                        <p>长按识别图中二维码</p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(window).ready(function(){
           $('#test1').click(function(){
            window.location.href="http://www.pgyer.com/huoqiwang";
        });
        //获取cookie
