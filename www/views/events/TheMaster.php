    ...
    <div id="header" class="top">
        ...
        <div id= 'red_packet' style="display:none;">
            <div class="hb" >
                ...
                <a class="use-hb" href="http://www.pgyer.com/huoqiwang">马上使用红包</a>
            </div>
        </div>
    </div>
    <div id="main">
        ...
        <div>
            ...
            <div class="info-W">
                ...
                <p>2.在活琪王上至少充值并投资1元，才可使用6000元体验金投资并计息，如果自有充值投资金额低于1元，计息停止。</p>
                <p>3.在活动期间，享受10.1%年化收益。</p>
                <p>4.每成功邀请一名好友，邀请和被邀请双方都随机获得1个1.0~10.1元的红包。</p>
                <p>5.活动结束且自有金额充值投资过一次后，利息收益及红包可赎回提现，体验金活琪王收回。</p>
                <p>6.本次活动，限前500名注册投资用户享受活动奖励，其他用户敬请期待活琪王正式上线活动。</p>
                <p>7.本次活动仅限Android用户参加，ios版本正在奋力开发中，敬请期待。</p>
                <p>8.本次活动最终解释权归活琪王所有，若经查证属实发现有作弊行为，活琪王有权力取消您的活动资格。</p>
            </div>
        </div>
    </div>
    <div id="footer" class="bottom clearFloat">
        <p class="phone-dow">
            <a href="http://www.pgyer.com/huoqiwang"><img width="269px" height="70px" src="<?php echo $directoryAsset;?>/images/events-nd/footer1.jpg" alt="安卓手机下载"></a>
