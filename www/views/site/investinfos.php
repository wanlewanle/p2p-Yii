        ...
        <div class="shadowBox m-b4 Shadow-add">
            ...
            <div class="single-page-nav clearFloat">
                ...
                <div class="single-page-navcon right" id="cfhk">
                    <p>通过“活琪王”所投资资产均为最高保证的资产类型。所有用户通过“活琪王”的投资均不会进行中小企业借贷类资产投资。资产投向分别为:</p>
                    ...
                    <p>
                        经过上述资产投向的资产保证后。活琪王还分别设立多层级的保证金制度，保证资产兑付风险。个人消费信贷类、车辆质押类、证券融资类资产均分别有各种形式的高额保证金，该保证金处于“活琪王”实际控制下，并在每项资产类目中予以实时展示相关余额。</p>

                    <p>另外，“活琪王”还设立了面向平台全部用户的资产投资余额设立“风险准备金”制度作为最后一层的保障。</p>
                </div>
                <div class="single-page-navcon right" id="ffzbj">
                    <p>
                        风险准备金保障计划指当投资人受让的债权债务人出现逾期，且用于保证还款的“质押物、保证物、抵押物等”发生代偿风险的。“活琪王”将从设立的风险保障金账户中的资金，先行偿付投资人对应该笔债权的本金以及相应的收益，从而为投资人营造一个安全的投资环境，保证投资人的本金安全。
                        “风险准备金账户”资金全部来源于“活琪王”选取的民间借贷项目中的借款人（债务人）收取，并将收取的风险准备金存放入“风险准备金账户”并进行专户管理，由招商银行监管。</p>
                </div>
                <div class="single-page-navcon right" id="dsfzh">
                    <p>
                        ...
                        为了最大确保全体理财人资金安全，活琪王大胆地与新浪支付进行了合作，资金全程由新浪支付托管，投资和还款资金开设独立专用账户，实时专款专用，从而与活琪王自有资金完全分离。同时有联合监管机构的实时监控，确保资金运转的合规透明。
                    </p>
                </div>
            </div>
        </div>
