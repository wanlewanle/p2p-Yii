...
<div class="wapper bgd-f5f5f4">
    ...
    <div class="header-top"><br><br><br>
        ...
        <p class="text-center f16 c-ffffff">HI~欢迎注册活琪王<br>
            活期理财，我们更专业！
        </p>
        <br>
        <br>
    ...
    <div class="content">
        ...
        <div class="cy-rg1 w90">
            ...
            <form  method="post" id="signupform" action="<?php echo yii\helpers\Url::to(['site/step2']);?>">
                ...
                <p class="text-center">注册即默认同意 <a href="javascript:;" id="protocol" class="c-e44949">《活琪王服务协议》</a></p>
                <br><br>
    ...
    <section class="protocol-chose">
        <div class="protocol-con">
            <h2 class="tit"><span>活琪王网站服务协议</span><i id="Close" class="icon-remove"></i></h2>
            <div class="protocol-word">
                <p>本网站由北京活琪王投资有限公司成立并运营。本服务协议双方为北京活琪王投资有限公司与活琪王用户，本服务协议具有合同效力。</p>
                <p>　　在您注册成为本网站用户前请务必仔细阅读以下条款。若您一旦注册，则表示您同意接受本网站的服务并接受以下条款的约束。若不接受以下条款，请停止注册本网站。</p>
                <p>　　本服务协议内容包括以下条款及已经发布的或将来可能发布的各类规则。所有规则为协议不可分割的一部分，与协议正文具有同等法律效力。本协议是由用户与本网站共同签订的，适用于用户在活琪王网站全部的活动。在用户注册时，用户已经阅读、理解并接受本协议的全部条款及各类规则，并承诺遵守中国现行的法律、法规、规章及其他政府规定，如有违反而导致任何法律后果的发生，用户将以自己的名义独立承担所有相应的法律责任。</p>
